...
- **AI Tools**: [How you use ChatGPT, Copilot, etc.]
- **Practice**: [LeetCode, side projects, OSS contributions]
...
- [Any automation that makes your work easier]
...
- Demo/Projects: [Links to live demos or project showcases]
